% IMPLICIT-RESPONSE RESIDUAL- SPACE MAPPING, I-RRSM-T1 ALGORITHM
...
while norm(Raim - R_f) > 1e-6
    ...
    fun_x = @(x)norm(R_f-(Rcoarse([l_c, w_c+x])+dR)); % cost function
...
title('Single Cheese Cutter: Implicit Response Residual Space Mapping Optimization-Type-I',...
